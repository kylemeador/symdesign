...
## Installation
1. First, you will need to set up your python environment. After cloning this repository, run `conda create env --file path/to/symdesign/conda_env.yml`. Might I also suggest using [mamba](https://github.com/mamba-org/mamba) inplace of conda for an even faster experience. This command will create a suitable environment to access all the contained tools.  
