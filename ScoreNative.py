...
def get_interface_ghost_surf_frags(pdb1, pdb2, pdb1_ghost_frag_list, pdb2_surf_frag_list, rot_mat1, rot_mat2, internal_tx_vec1, internal_tx_vec2, set_mat1, set_mat2, ext_tx_vec1, ext_tx_vec2, cb_distance=9.0):
    ...
    for int_ghost_frag_index in range(len(interface_ghost_frag_list)):
        ...
        int_ghost_frag_pdb_coords = interface_ghost_frag_pdb_coords_list[int_ghost_frag_index]
        ...
        int_ghost_frag = GhostFragment(int_ghost_frag_pdb, int_ghost_frag.get_i_frag_type(),
                                                   ...
                                                   guide_atoms=int_ghost_frag_pdb_atoms[-3:],
                                                   guide_coords=int_ghost_frag_pdb_coords[-3:],
                                                   pdb_coords=int_ghost_frag_pdb_coords)

        interface_ghost_frag_list.append(int_ghost_frag)
        interface_ghost_frag_guide_coords_list.append(int_ghost_frag.get_guide_coords())
