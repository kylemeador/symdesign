...
def insert_dataframe(session: Session, table: sql.Base, df: pd.DataFrame):  # -> list[int]:
...
def upsert_dataframe(session: Session, table: sql.Base, df: pd.DataFrame):  # -> list[int]:
