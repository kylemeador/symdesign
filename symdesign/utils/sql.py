...
class Designs(Base):
    ...
    proteinmpnn_loss_design = Column(Float)  # , nullable=False)
    proteinmpnn_loss_evolution = Column(Float)  # , nullable=False)
    proteinmpnn_loss_fragment = Column(Float)  # , nullable=False)
