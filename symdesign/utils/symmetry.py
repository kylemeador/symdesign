...
# All comments below are describing rotation according to viewing the origin from a point on the described basis vector
...
setting_matrices = {
    ...
    # [[1., 0., 0.], [0., 1., 0.], [0., 0., 1.]])
    # 90 degrees CCW on Y
    2: Rotation.from_euler('y', math.pi / 2).as_matrix(),
    # [[0., 0., 1.], [0., 1., 0.], [-1., 0., 0.]]
    # 45 degrees CCW on Y, which is 2-fold axis in O
    3: Rotation.from_euler('y', math.pi / 4).as_matrix(),
    # [[.707107, 0., .707107], [0., 1., 0.], [-.707107, 0., .707107]]
    # ~54.73 degrees CW on X, 45 degrees CW on Z, which is X,Y,Z body diagonal or 3-fold axis in T, O
    4: Rotation.from_euler('xz', (-math.acos(-1/3) / 2, -math.pi / 4)).as_matrix(),
    # [[0.707107, 0.408248, 0.577350], [-0.707107, 0.408248, 0.577350], [0.0, -0.816497, 0.577350]]
    # 45 degrees CW on Z
    5: Rotation.from_euler('z', -math.pi / 4).as_matrix(),
    # [[.707107, .707107, 0.], [-.707107, .707107, 0.0], [0., 0., 1.]]
    # 90 degrees CW on X
    6: Rotation.from_euler('x', -math.pi / 2).as_matrix(),
    # [[1., 0., 0.], [0., 0., 1.], [0., -1., 0.]]
    # ~20.91 degrees CW on X which is 3-fold axis in I (2-fold is positive Z)
    7: Rotation.from_euler('x', (math.pi - math.acos(-math.sqrt(5)/3)) / 2).as_matrix(),
    # [[1., 0., 0.], [0., .934172, .356822], [0., -.356822, .934172]]
    # 90 degrees CW on Y, 135 degrees CW on Z, which puts Z on 45 degree X,Y plane diagonal in D4
    8: Rotation.from_euler('yz', (-math.pi/2, -math.pi * 3/4)).as_matrix(),
    # [[0., .707107, .707107], [0., -.707107, .707107], [1., 0., 0.]]
    # ~31.72 degrees CCW on Y which is 5-fold axis in I (2-fold is positive Z)
    9: Rotation.from_euler('y', (math.pi - math.acos(-math.sqrt(5) / 5)) / 2).as_matrix(),
    # [[.850651, 0., .525732], [0., 1., 0.], [-0.525732, 0., .850651]]
    # 90 degrees CW on Y, 150 degrees CW on Z, which is 60 degree X,Y plane diagonal in D6
    10: Rotation.from_euler('yz', (-math.pi / 2, -math.pi * 5/6)).as_matrix(),
    # [[0., .5, .866025], [0., -.866025, .5], [1., 0., 0.]]
    # 90 degrees CCW on Z
    11: Rotation.from_euler('z', math.pi / 2).as_matrix(),
    # [[0., -1., 0.], [1., 0., 0.], [0., 0., 1.]]
    # ~54.73 degrees CCW on X, 45 degrees CCW on Z, which puts Z on X,-Y,Z body diagonal or opposite 3-fold in T, O
    12: Rotation.from_euler('xz', (math.acos(-1/3) / 2, math.pi / 4)).as_matrix(),
    # [[0.707107, -0.408248, 0.577350], [0.707107, 0.408248, -0.577350], [0.0, 0.816497, 0.577350]]
    # 60 degrees CCW on Z
    13: Rotation.from_euler('z', math.pi / 3).as_matrix(),
    # [[.5, -.866025, 0.], [.866025, .5, 0.], [0., 0., 1.]]
    }
inv_setting_matrices = {key: np.linalg.inv(setting_matrix) for key, setting_matrix in setting_matrices.items()}
# Rotation 180 degrees on X
flip_x_matrix = Rotation.from_euler('x', math.pi).as_matrix()
# [[1., 0., 0.], [0., -1., 0.], [0., 0., -1.]]
# Rotation 180 degrees on Y
flip_y_matrix = Rotation.from_euler('y', math.pi).as_matrix()
# [[-1., 0., 0.], [0., 1., 0.], [0., 0., -1.]]
