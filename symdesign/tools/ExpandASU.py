...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--symmetry', type=str, choices=utils.symmetry.cubic_point_groups,
                        help='What symmetry to be expanded?', required=True)
    ...
    files = utils.to_iterable(args.file, ensure_file=True)
