...
python $SymDesign/dependencies/python/WriteSBATCH.py -f ${1}/${stages[0]}.cmd ${scripts[0]} --default
python $SymDesign/dependencies/python/WriteSBATCH.py -f ${1}/${stages[1]}.cmd ${scripts[1]} --default  # --tasks 11 --mem 4000
python $SymDesign/dependencies/python/WriteSBATCH.py -f ${1}/${stages[2]}.cmd ${scripts[2]} --default
# python $SymDesign/dependencies/python/WriteSBATCH.py -f ${1}/${stages[3]}.cmd ${scripts[3]} --default
