...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1 and sys.argv[1] == '-query':
        ...
        try:
            ...
            pdb1_oriented_filepaths = [orient_pdb_file(pdb1_path, log=master_logger, sym=sym_entry.get_group1_sym(),
            ...
            if sym_entry.get_group1_sym() == sym_entry.get_group2_sym() and '.pdb' not in pdb2_path:
                ...
                pdb2_oriented_filepaths = [orient_pdb_file(pdb2_path, log=master_logger, sym=sym_entry.get_group2_sym(),
