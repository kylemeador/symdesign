...
class EulerLookup:
    def __init__(self, scale=3.0, binary_lookup_table_path=os.path.dirname(os.path.dirname(os.path.realpath(__file__))) + "/euler_lookup_table_40/euler_lookup_40_binary.npy"):
