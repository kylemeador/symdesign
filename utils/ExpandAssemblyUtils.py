...
def generate_cryst1_record(dimensions, spacegroup):
    ...
    sg_cryst1_fmt_dict = {'F222': 'F 2 2 2', 'P6222': 'P 62 2 2', 'I4132': 'I 41 3 2', 'P432': 'P 4 3 2', 'P6322': 'P 63 2 2', 'I4122': 'I 41 2 2', 'I213': 'I 21 3', 'I422': 'I 4 2 2', 'I432': 'I 4 3 2', 'P4222': 'P 42 2 2', 'F23': 'F 2 3', 'P23': 'P 2 3', 'P213': 'P 21 3', 'F432': 'F 4 3 2', 'P622': 'P 6 2 2', 'P4232': 'P 42 3 2', 'F4132': 'F 41 3 2', 'P4132': 'P 41 3 2', 'P422': 'P 4 2 2', 'P312': 'P 3 1 2', 'R32': 'R 3 2'}
    pg_cryst1_fmt_dict = {'p3': 'P 3', 'p321': 'P 3 2 1', 'p622': 'P 6 2 2', 'p4': 'P 4', 'p222': 'P 2 2 2', 'p422': 'P 4 2 2', 'p4212': 'P 4 21 2', 'p6': 'P 6', 'p312': 'P 3 1 2', 'c222': 'C 2 2 2'}
    zvalue_dict = {'P 2 3': 12, 'P 42 2 2': 8, 'P 3 2 1': 6, 'P 63 2 2': 12, 'P 3 1 2': 12, 'P 6 2 2': 12, 'F 2 3': 48, 'F 2 2 2': 16, 'P 62 2 2': 12, 'I 4 2 2': 16, 'I 21 3': 24, 'R 3 2': 6, 'P 4 21 2': 8, 'I 4 3 2': 48, 'P 41 3 2': 24, 'I 41 3 2': 48, 'P 3': 3, 'P 6': 6, 'I 41 2 2': 16, 'P 4': 4, 'C 2 2 2': 8, 'P 2 2 2': 4, 'P 21 3': 12, 'F 41 3 2': 96, 'P 4 2 2': 8, 'P 4 3 2': 24, 'F 4 3 2': 96, 'P 42 3 2': 24}
...
def get_ptgrp_sym_op(sym_type, expand_matrix_dir=os.path.dirname(os.path.dirname(os.path.realpath(__file__))) + "/ExpandMatrices/POINT_GROUP_SYMM_OPERATORS"):
...
def cart_to_frac(cart_coords, dimensions):
    ...
    if len(dimensions) == 6:
        ...
        M_0 = [1/a, -(np.cos(gamma)/float(a*np.sin(gamma))), (((b*np.cos(gamma)*c*(np.cos(alpha)-(np.cos(beta)*np.cos(gamma)))) / float(np.sin(gamma)))-(b*c*np.cos(beta)*np.sin(gamma)))*(1/float(v))]
        ...
        raise ValueError("UNIT CELL DIMENSIONS INCORRECTLY SPECIFIED. CORRECT FORMAT IS: [a, b, c,  alpha, beta, gamma]")
...
def uc_expansion_is_clash(central_unit_cell, clash_distance=2.2):
    ...
    cb_clash_count = kdtree_central_asu_bb.two_point_correlation(central_unit_cell_wo_central_asu_bb_coords, [clash_distance])
...
def surrounding_uc_is_clash(central_unit_cell, surrounding_unit_cells, clash_distance=2.2):
    ...
    kdtree_central_asu_bb = sklearn.neighbors.BallTree(np.array(central_asu_pdb_bb_coords))
    cb_clash_count = kdtree_central_asu_bb.two_point_correlation(all_unit_cells_wo_central_asu_bb_coords, [clash_distance])
