...
def rand_perturb(pdb1_path, pdb2_path, set_matrix1, set_matrix2, rot_degen_matrix1, rot_degen_matrix2, internal_tx1, internal_tx2, ref_frame_tx_dof1, ref_frame_tx_dof2, ref_frame_tx_param_e, ref_frame_tx_param_f, ref_frame_tx_param_g, result_design_sym, uc_spec_string, has_int_rot_dof_1, has_int_rot_dof_2, number_of_perturbations, outdir):
    ...
    for perturb_number in range(number_of_perturbations):
        ...
        pdb1_rand_perturb_path = outdir + "/" + os.path.splitext(os.path.basename(pdb1.filepath))[0] + "_rand_perturb_" + str(perturb_number) + ".pdb"
        pdb2_rand_perturb_path = outdir + "/" + os.path.splitext(os.path.basename(pdb2.filepath))[0] + "_rand_perturb_" + str(perturb_number) + ".pdb"
        ...
        logfile.write("PERTURBED REFERENCE FRAME Tx PARAMETERS: e: %s, f: %s, g: %s\n" % (e_perturbed, f_perturbed, g_perturbed))
...
def main():
    ...
    pdb1_path, pdb2_path, set_matrix1, set_matrix2, rot_degen_matrix1, rot_degen_matrix2, internal_tx1, internal_tx2, ref_frame_tx_dof1, ref_frame_tx_dof2, ref_frame_tx_param_e, ref_frame_tx_param_f, ref_frame_tx_param_g, result_design_sym, uc_spec_string, has_int_rot_dof_1, has_int_rot_dof_2 = get_docked_pose_info(infofile_path)
    rand_perturb(pdb1_path, pdb2_path, set_matrix1, set_matrix2, rot_degen_matrix1, rot_degen_matrix2, internal_tx1, internal_tx2, ref_frame_tx_dof1, ref_frame_tx_dof2, ref_frame_tx_param_e, ref_frame_tx_param_f, ref_frame_tx_param_g, result_design_sym, uc_spec_string, has_int_rot_dof_1, has_int_rot_dof_2, number_of_perturbations, outdir)
