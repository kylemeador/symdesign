...
def get_interface_ghost_surf_frags(pdb1, pdb2, pdb1_ghost_frag_list, pdb2_surf_frag_list, rot_mat1, rot_mat2,
    ...
    interface_ghost_frag_guide_coords_list = []
    ...
    for ghost_frag in pdb1_ghost_frag_list:
        if ghost_frag.get_aligned_surf_frag_central_res_tup() in pdb1_central_resnum_chainid_unique_list:
            ...
            interface_ghost_frag_guide_coords_list.append(ghost_frag.get_guide_coords())
    ...
    interface_ghost_frag_guide_coords_list_transformed = rot_txint_set_txext_frag_coord_sets(
        interface_ghost_frag_guide_coords_list, rot_mat=rot_mat1, internal_tx_vec=internal_tx_vec1, set_mat=set_mat1,
        ext_tx_vec=ext_tx_vec1)
    ...
    #                                                int_ghost_frag.get_j_type(), int_ghost_frag.get_k_type(),
    ...
    return np.array(interface_ghost_frag_guide_coords_list_transformed), \
        np.array(interface_surf_frag_guide_coords_list_transformed), \
        len(pdb1_central_resnum_chainid_unique_list), len(pdb2_central_resnum_chainid_unique_list)
