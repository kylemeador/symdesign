...
echo "
# Hey Kaylie. 
# To start, copy the files in this directory \'scp /yeates1/kmeador/kaylie_nanohedra_testing /yeates1/kbair/\'. You will need to set up a directory on /yeates1. I suggest this storage device because it is accessible to both escher and cassini.
...
# T33 - Point group
python /yeates1/kmeador/symdesign/Nanohedra.py -dock -entry 54 -pdb_dir1_path C3/3tcr.pdb1 -pdb_dir2_path C3/3mjz.pdb1 -rot_step1 3 -rot_step2 3 -outdir /yeates1/kmeador/symdesign2/unit_testing/NanohedraEntry54DockedPoses -output_assembly

# p222 - Layer group (no rotational degrees of freedom)
python /yeates1/kmeador/symdesign/Nanohedra.py -dock -entry 84 -pdb_dir1_path D2/3wb0.pdb1 -pdb_dir2_path D2/1rcu.pdb1 -outdir /yeates1/kmeador/symdesign2/unit_testing/NanohedraEntry84DockedPoses -output_assembly

# P432 - Space group (pdb1 rotational degree of freedom)
python /yeates1/kmeador/symdesign/Nanohedra.py -dock -entry 67 -pdb_dir1_path C3/1vhc.pdb1 -pdb_dir2_path C4/2fw7.pdb1 -rot_step1 3 -outdir /yeates1/kmeador/symdesign2/unit_testing/NanohedraEntry67DockedPoses -output_assembly
