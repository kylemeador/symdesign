def print_usage():
    ...
    print(
        'python Nanohedra.py -dock_mp -entry 65 -pdb_dir1_path /home/user/SymBuildBlocks/C3 -pdb_dir2_path /home/user/SymBuildBlocks/D4 -outdir /home/user/SymDockProject')
    print(
        'python Nanohedra.py -postprocess -design_dir /home/user/SymDockProject -min_matched 7 -outdir /home/user/SymDockProject/PostProcess')
    print(
        'python Nanohedra.py -postprocess -design_dir /home/user/SymDockProject -min_score 5.0 -outdir /home/user/SymDockProject/PostProcess')
    print(
        'python Nanohedra.py -postprocess -design_dir /home/user/SymDockProject -min_matched 7 -min_score 5.0 -outdir /home/user/SymDockProject/PostProcess')
    print('')
